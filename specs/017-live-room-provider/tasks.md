...
- [ ] T051 ⏸️ **محجوبٌ حتى يتوفّر مشروع LiveKit Cloud ودلو R2** — لا يُنفَّذ بلا حساب، وهذا بنصّ `SC-006`: البوابة خضراء بدونهما، والاثنا عشر خطوة هي ما لا تُثبته بوابةٌ خضراء أبداً. النصّ الأصلي: نفّذ الخطوات الاثنتَي عشرة اليدوية في `quickstart.md` §ج مقابل مشروع LiveKit Cloud ودلو R2، وسجّل نتائجها في جدول Deferred Verification في `plan.md` — **خمسةٌ منها لا تُثبتها بوابةٌ خضراء أبداً**
