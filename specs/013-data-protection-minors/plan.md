...
**حارسُ رؤية المدرّس للطالب** (‏`NFR-001أ`): لا نقطةَ نهايةٍ في هذه المرحلة تُقرأ بعينِ مدرّس.
طلباتُ الحقوق يقرؤها صاحبُها أو موظّفُ منصّة، وكتالوجُ الأصناف مرجعيٌّ عامّ. **والخطرُ
المعاكس** هو ما يجب حراستُه: طلبٌ يُنشئه وليُّ أمرٍ **باسم طالبٍ ليس ابنَه** — فالحارسُ إثباتُ
العلاقة، وهو نفسُ ما تفعله هجرةُ `terms_consents` بعمودَي `user_id` و`student_user_id`
المنفصلَين، وبنفس السبب المكتوب فيها: بلا إثباتِ الرابط، أيُّ مستخدمٍ يوقّع وثيقةً باسم غيره
والردُّ يؤكّد أن المعرّف لشخصٍ حقيقيّ. الحارسُ `ParentStudentRelationPolicy` القائم.
