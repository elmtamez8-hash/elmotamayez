...
**والمشيةُ (T048) كُتِبَت بدلَ أن تُمشى بالعين**:
`backend/tests/Feature/Learning/AudienceWalkTest.php` — بحسابِ طالبٍ من كلِّ
مجموعةٍ وواحدٍ بلا مجموعة، يُقرَأُ المنهجُ ثمّ يُطرَقُ **كلُّ عنصرٍ في الكورس**
على كلِّ بابٍ يملكُه: صفحةُ الدرس، ومنحةُ التشغيل، وبدءُ المحاولة، وفهرسُ
الاختبارات ⇒ صفرُ فروق.

⚠️ **والعينُ ترى المعروضَ ولا ترى المحجوب**، وذلكَ نصفُ SC-001: صفٌّ مُسقَطٌ من
الشجرةِ وبابُه مفتوحٌ لمن يحملُ المعرّفَ هو «بابانِ يختلفان». فالمكتوبةُ تغطّي
ما لا تغطّيه المشيةُ اليدويّةُ أصلاً، وتُعادُ في كلِّ بناء. مثبَّتةٌ بالتخريب:
حذفُ سؤالِ `LessonAudience` من `IssuePlaybackGrant::mayWatch()` ⇒ «alpha: عنصرٌ
محجوبٌ من المنهجِ فتحَه بابُ التشغيل».

**تمّت المواصفةُ ٠٢٦ كاملةً: ٤٨ مهمّةً من ٤٨.**
...
- [X] T047 بوّاباتٌ: `./vendor/bin/pint` · `./vendor/bin/phpstan analyse` · `php vendor/bin/pest tests/Feature/Learning tests/Feature/Courses tests/Feature/Assessments tests/Feature/Media` · `npx tsc --noEmit` · `npm test`
- [X] T048 مشيةٌ يدويّةٌ: بحسابِ طالبٍ من كلِّ مجموعةٍ، افتحِ المنهجَ وقارنْ **ما يُعرَضُ بما يُفتَح** ⇒ صفرُ فروق (SC-001)
