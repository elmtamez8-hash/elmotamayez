...
- [ ] T186 ⏸️ **لم تُمشَ بعد** (‏٢٠٢٦-٠٨-٢٥): تحتاج أربعَ عمليّاتٍ دائمةً وحسابَين في متصفّحَين ومدرّسَين لخطوةِ الكشف. البوّاباتُ الأربعُ خضراء، والمشيةُ هي ما لا تُثبته أيٌّ منها. امشِ `quickstart.md` §ب يدوياً بالاثنتَي عشرةَ خطوة — بما فيها **إيقافُ `reverb`** وإعادةُ لصقِ معرّفِ محادثةٍ ليست للقارئ
