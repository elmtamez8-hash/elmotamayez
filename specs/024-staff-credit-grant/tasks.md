...
- [X] T034 امشِ [quickstart.md](./quickstart.md) يدويّاً على `/admin` — السيناريوهاتُ ١ و٢ و٣ و٥. ⚠️ **السيناريو ٣ هو الذي لا تراه أيُّ تجهيزةٍ بمساحةٍ واحدة**
  ⟨مُشِيَ في ٢٠٢٦-٠٩-١٠ محلّيّاً بحساب `teacher@example.com` — موظّفُ ماليةٍ **ليسَ** سوبر أدمن، يملكُ مساحةَ العملِ ١، والكورسُ في مساحةِ العملِ ٢.⟩
  - **س١ ✅** قبلَ الاعتماد: `credit_balances` = **٠ · ٠** · `enrollments` = **٠** · الطلبُ `under_review` بـ`granted_by=2`. وبعدَه: **٨ · ٨** على الكورسِ ٢ وحدَه، و`enrollments` = **٠** (FR-004أ). والمبلغُ المتوقَّعُ ظهرَ قبلَ الحفظِ: **960.00 QAR**.
  - **س٢ ✅** الطالبُ هو المدرّس ⇒ «لا يمكن منح أرصدة لمن يدرّس هذا الكورس» **قبلَ الحفظ** · بلا `billing.purchase.approve` ⇒ **403** ولا رابطَ في التنقّل · مالكُ مساحةِ العمل ⇒ **نفسُ القياس**: حذفُ صفِّ `platform_staff` يتركُه مالكَ مساحةٍ فحسب، و`mayAccessAdminPanel()` تردُّه عندَ بابِ اللوحةِ نفسِه · كورسٌ بلا معدّلٍ معتمَد ⇒ «لا تسعير متاح لهذا الكورس حاليّاً» قبلَ الحفظ.
  - **س٣ ✅ الحالتانِ معاً.** أ (‏`last_workspace_id = 1` والكورسُ في مساحةٍ أخرى) ⇒ ٢٠٠ في المنحِ والاعتماد. ب (‏`last_workspace_id = NULL`) ⇒ ٢٠٠ كذلك، ورصيدٌ ٨ · ٨. ⚠️ **وحالةُ «ب» مشروطة**: `WorkspaceContext::id()` تقرأُ مفتاحَ الجلسةِ **قبلَ** العمود، ولم أستطعْ قراءةَ حمولةِ الجلسةِ لأتحقّقَ أنّها خالية — كاتباهُ الوحيدانِ (`AcceptInvitation` · `SwitchWorkspace`) لا يُبلَغانِ من `/admin`، وهذه حجّةٌ من الكودِ لا قياس. **الحالةُ «أ» هي الحاملةُ على أيّةِ حال.**
  - **س٥ ✅ الاتّجاهانِ معاً.** منحُ الموظّفِ: `user_id`=الطالب، `granted_by=2`، `approved_by=2`. وشراءُ طالبٍ بنفسِه: `granted_by = NULL`.
  - ⚠️ **وعائقٌ لم تذكرْه المتطلّبات**: `TwoFactorMandate` ردَّ المنحَ أوّلَ مرّة — مهلةُ الحسابِ انتهت في ٢٠٢٦-٠٨-٢٠. ليس عطلاً، بل بياناتُ تطويرٍ تقادمَت؛ أُعيدَ الحسابُ داخلَ مهلتِه. **وعلى الإنتاجِ المهلةُ تنتهي ٢٠٢٦-٠٩-١٧** ولا ثانيَ عاملٍ مُفعَّلاً، فالشاشةُ تتوقّفُ يومَها.
