...
و**علامة مائية** هي نفسها ما يجدّد المنحة، و**جهازاً واحداً نشطاً لكل حساب طالب**، و**تحققاً ثنائياً**
للمدرّس والإدارة.
...
2. **العلامة المائية هي حلقة التجديد.** إخفاؤها من DOM يوقف التجديد، فتنتهي المنحة،
   ...
   راجع research §R5.
3. **حدّ الأجهزة يقع على الأجهزة لا على البصمة ولا على الجلسات.** البصمة تُجمِّع فقط؛
   والحدّ يُفرَض بحذف رمز Sanctum — وهو ما لا يستطيع العميل تزويره. راجع research §R7.
...
7. **الحدّ الافتراضي جهاز واحد، والعدّ على الأجهزة المتمايزة** — «جهازين» تعني جهازين لا
   جلستين: جلستان على حاسوب واحد تبقيان. راجع research §R7 (تصحيح 2026-08-05).
5. **الخروج التلقائي لجلسة الجهاز الأقدم بلا فعل من صاحبها** — ثلاث طبقات كلها قائمة في التصميم
...
| `Device` | **مملوك للمنصة** | حدّ الأجهزة على حساب الطالب كله. `BelongsToWorkspace` عليه يعني حدّاً لكل مدرّس — فتسقط الحماية بتسجيل ثانٍ (`docs/roadmap.md` §٥ج يسمّيه صراحةً) |
...
يرى **قائمة أجهزة واحدة** لا ثلاث نسخ بعد التسجيل عند ثلاثة مدرّسين.
