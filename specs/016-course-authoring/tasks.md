...
> **مؤجَّل بقرار، لا سهواً**: `LessonTypeRegistry::family()` بلا مُنادٍ بينما `LessonEditor.tsx`
> يكرّر خريطة العائلات التي يملكها السجلّ. الإصلاح الصحيح إرسال `family` في الحمولة وتوجيه
> المحرّر بها — وهو تغيير تصميم لا تنظيف، ويمسّ المحرّر الذي تمسّه US6 أصلاً. يُحسم في Polish.
