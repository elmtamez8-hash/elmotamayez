...
- [X] T035 [P] أضف قسمَ «قناة واتساب» إلى `docs/deployment.md`: حسابُ 360dialog · توثيقُ Meta · رقمُ الهاتف · **اعتمادُ ١٨ قالباً** · قلبُ `provider_approval_status` بعد كلّ اعتماد · ⚠️ `contact_verification` **أوّلاً** فقبله لا يتحقّق رقمٌ واحد
