  ...
  */
  ...
  return (
    ...
    >
      ...
      {/*
        الاسمُ على الكارتِ وحدَه: شريحةُ المادّةِ تحتَ عنوانِ الصفحةِ تقولُها
        بالفعل في صفحةِ الكورس، وتكرارُها في الشريطِ فوقَها مباشرةً سطرانِ
        متطابقانِ بحجمَين.
      */}
      {variant === "card" && subject && (
        <span className="px-4 text-center text-xs font-bold text-primary-ink/70">
          {subject.name}
        </span>
      )}
