...
const BY_CODE: Record<string, string> = {
  ...
  /*
    ...
    البابُ يردُّ ٤٠٤ عن درسٍ لا تسجيلَ للقارئِ فيه — وهذا صحيح: أنَّ درساً بعينِه
    موجودٌ عند هذا المعرّفِ هو نفسُه معلومة. لكنَّ `BY_STATUS[404]` كان يطبعُ
    «العنصر المطلوب غير موجود أو حُذف»، فقيلَ لمالكِ المنصّةِ إنَّ المحتوى
    **حُذِف** بينما هو قائمٌ ولا يخصُّه. بلاغُ ٢٠٢٦-٠٩-١٦، ومعه أخوه تحته.

    والرمزُ هو الآليّةُ لا النصّ: الخادمُ يُرسِلُ الجملةَ كذلك، وهذا الملفُّ
    لا يثقُ بنصِّ ٤٠٤ أبداً — ٤٠٤ الإطاريُّ إنجليزيٌّ ولا يصلحُ لشاشة.
  */
  not_enrolled: "هذا الدرس ليس ضمن كورساتك — يُفتح لمن سجّل في الكورس.",
  // والشقُّ الثاني من البلاغِ نفسِه: المالكُ يحملُ صلاحيّةَ كشفِ التسوية
