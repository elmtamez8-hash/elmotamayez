...
export interface User {
   ...
   *
   * ⚠️ مجموعةٌ لا قيمة: مدرّسٌ يدرسُ عندَ غيرِه — ووليُّ أمرٍ يدرسُ هو أيضاً —
   * يجبُ أن يرى الجانبَين. ويحسبُها الخادمُ من الدَّورِ في المحورِ لا من
   * `platform_role` وحدَه، وهو فارغٌ عندَ عشراتِ الحسابات.
   *
   * ⚠️ ومجموعةٌ بكلِّ الأدوارِ تعني «لا نعرف» لا «كلُّ شيءٍ يخصُّه»: الخادمُ
   * يُرجِعُها حينَ لا يُميِّزُ الحساب، لأنّ إخفاءَ فئةٍ بياناتُ صاحبِها فيها
   * شاشةُ موافقةٍ تكذِب.
   */
  data_subject_roles: PlatformRole[];
   ...
   * أو وليُّ أمر، وهم أغلبية الحسابات ويُتخطَّون على الخادم أصلًا)، واحد ⇒ اسم
   * المكان نفسه، أكثر ⇒ «أماكن عملي». ولذلك يحمل الحقل الاسمَ لا العددَ وحده:
