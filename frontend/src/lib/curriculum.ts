...
export interface Curriculum {
  course: {
    ...
    course_type: string;
    /**
     * ⛔ **الواقع، لا الإعلان — وهما سؤالان.**
     *
     * تبويبُ «الحصص» وعدّادُ الحصّةِ القادمةِ كانا يُشتَقّانِ من
     * `course_type !== "recorded"`، وذلكَ العمودُ عاشَ بلا كاتبٍ من ٢٠٢٦-٠٨-٠١
     * إلى ٢٠٢٦-٠٩-١٥ — فكورسٌ على الإنتاجِ بثماني حصصٍ حيّةٍ ومجموعةٍ مفتوحةٍ
     * لم يعرضْ منها شيئاً لأربعةِ طلبةٍ مسجَّلين. صارَ للعمودِ كاتبٌ، لكنّ
     * إعلانَ المدرّسِ ليسَ الواقع: اختيارٌ خاطئٌ منه يُخفي الجدولَ في صمت،
     * بينما شارةً خاطئةً في السوقِ يراها الناسُ فيُبلِّغون.
     */
