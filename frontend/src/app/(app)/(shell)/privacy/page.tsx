  ...
  return (
    <div className="space-y-6">
      ...
      */}
      ...
      <Alert tone="info" title="حقوقك الأخرى">
        طلب نسخة من بياناتك أو حذفها متاح قريباً من هذه الصفحة. حتى ذلك الحين، راسِلْنا
        وسنعالج الطلب خلال المدّة المعلَنة في السياسة.
      </Alert>
    </div>
  );
}
