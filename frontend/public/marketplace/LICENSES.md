...
> ⚠️ **عمودية ١٢٠٠×١٦٠٠، لا ٱلبنر العريض.** لوحة `AuthShell` تشغل نصف الشاشة
> بارتفاعها كاملاً، و`object-cover` على صورة ١٨٠٠×٦٤٠ داخل إطارٍ طوليٍّ يقصّ
> الموضوع كلَّه تقريباً. المقاس هو ما يمنع ذلك، لا إعدادٌ في CSS.
>
> ⚠️ **وثلاثة اختيارات رُفضت هنا أيضاً، للأسباب نفسها التي رُفض بها بنر «رفّ
> الكتب»**: مشهد فصلٍ إندونيسيّ (زيّ مدرسيّ وباتيك — والسوق عربيّ)، وسيدة أمام
> حاسوبٍ في مكتبٍ غربيّ بلوحةٍ باردة لا تلتقي مع العنّابيّ، وفصلٌ ريفيٌّ إثيوبيّ
> بخطٍّ أمهريّ ولوحةٍ زرقاء — وهذه الأخيرة تقرأ فقراً، وهي نبرةٌ لا تخصّ صفحةَ
> تسجيلٍ في منصّةٍ تُباع بالاشتراك. ورابعةٌ — شخصان يتعلّمان حول طاولة — كانت
> ورقةَ تمارينَ **إنجليزيةً مقروءةً بالكامل** على منصّةٍ عربيةٍ فقط.
>
> `auth-invitation.webp` بابٌ عربيّ وجريدةٌ عربية عمداً: الدعوة تصل مساعدَ مدرّسٍ
> ينضمّ إلى مساحة عمل، فالشاشة تقول «هذا المكان» قبل أن تُقرأ كلمة.

نُزّلت في **٢٠٢٦-٠٩-٠١** بصيغة WebP وجودة 78، مقصوصة على مقاس الحاوية النهائي.
