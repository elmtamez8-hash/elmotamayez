...
return [
    ...
    'custom' => [
        ...
        // `POST /auth/register` بالدعوة وحدها (2026-09-24). الجملةُ تدلُّ على
        // الباب الصحيح بدلَ أن تقولَ «الدعوة مطلوبة» لزائرٍ لا يملكُ دعوة.
        'invitation' => [
            'required' => 'إنشاء الحساب من هذه الصفحة يكون بدعوةٍ فقط. الطلاب وأولياء الأمور والمدرّسون يسجّلون من صفحة التسجيل.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        */
        ...
        // ⚠️ `mode` هنا يعني «نمط الفوترة» (مسبَق/آجل) في `UpdateBillingSettingsRequest`.
        // وشراء الاشتراك (027) يحمل حقلاً بالاسم نفسه ومعنى آخر: «مجموعة أو حصص
        // خاصّة». هذه المصفوفة عالمية بالاسم لا بالطلب، فاسم واحد لا يخدم معنيين —
        // ولذلك يتجاوزه `PurchaseSubscriptionRequest::attributes()` عنده وحده.
        'mode' => 'نمط الفوترة',
        'cadence' => 'دورة الدفع',
        ...
        // الاشتراك من صفحة الكورس (027)
        'plan_uuid' => 'الباقة',
        'cohort_uuid' => 'المجموعة',

        // لمن هذا العنصر (026)
        'cohort_uuids' => 'المجموعات المقصود بها هذا العنصر',
        'cohort_uuids.*' => 'المجموعة المختارة',
        'release_session_uuid' => 'حصّة ظهور هذا العنصر',
