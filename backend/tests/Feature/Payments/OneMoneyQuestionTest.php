...
| ومساحةُ العمل. وليسَت حالةً نادرة: `ReleaseIneligibleBookings` يمرِّرُ كلَّ
| مقعدٍ محجوزٍ على `allows()` كلَّ ليلة، فالازدواجُ يقعُ مرّةً لكلِّ طالبٍ
| غيرِ مستحقٍّ في كلِّ حصّة.
|
| ⚠️ **والـ`enrollments` الذي كانَ مقروءاً مرّتَينِ ليسَ من هذا**، وقد سُمِّيَ
| سببُهُ وأُغلِقَ بعدَها: `ClassSessionPolicy::view()` يسألُ عندَ الباب ثمّ
| `BookingEligibility` يسألُ خلفَه. مقيسٌ ومحروسٌ في
| `BookingPathReadsOnceTest`.
|
| ⚠️ **ولم تُحَلَّ بذاكرةٍ مؤقّتة**، وهذا الرفضُ مقصودٌ وقائم: ذلكَ الكنسُ يمسكُ
| نسخةً واحدةً من الصنفِ طوالَ دورتِه **ويُحرِّرُ رصيداً داخلَها**، فحكمٌ محفوظٌ
| يعيشُ أطولَ من الرصيدِ الذي يصفُه. وجارَتاهُ — `EloquentEnrollmentDirectory`
| و`SubscriptionEligibility` — تحفظانِ فعلاً، والفرقُ هو ما يُبطِلُ الحفظ:
| كلُّ كتابةٍ على الصفِّ تُسقِطُ ذاكرتَه. ولا يملكُ الرصيدُ ذلكَ المفتاحَ هنا،
| لأنَّ `is_withheld` مشتقٌّ من خمسةِ مدخلاتٍ ليسَ لواحدٍ منها صفٌّ يُكتَب.
|
