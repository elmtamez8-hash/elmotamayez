...
/**
 * Create `announcements.manage` and give it to every EXISTING role the matrix
 * says holds it.
 *
 * ⚠️ THE SAME TRAP AS `chat.reply`, `chat.moderate` AND `reviews.periodic.manage`,
 * FIFTH TIME IN THIS
 * REPOSITORY: the matrix is a SEED that `SeedDefaultRoles` runs exactly once, when
