 ...
 * practice attempt does NOT emit is `ExamPassed`, which completes a pass-gated
 * exam item (and so, at the end of a course, leads to the certificate) and
 * belongs to a sitting rather than to revision.
 */
