...
class BroadcastController extends Controller
{
    ...
    /**
     * النبضة — تُجيبُ بما يعتقدُه **الخادم**، لا بما أرسلَه العميل: الصفحةُ
     * تعرضُ والخادمُ يقرّر.
     *
     * ⛔ **وتسألُ أسئلةَ السحبِ وحدَها، لا سلسلةَ الباب.**
     *
     * ⚠️ كتلةٌ ثانيةٌ كانت فوقَ هذه تقولُ «يُرفَضُ كلُّ من لا يستطيعُ أخذَ
     * تذكرة»، وقد صارَ ذلكَ غيرَ صحيحٍ بالقصد: طالبةٌ نفدَ رصيدُها تُكمِلُ
     * حصّتَها ويرفضُها البابُ وحدَه — ويُثبِتُه شقُّ «ما زالَ البابُ يرفضُه».
     * وPHP تأخذُ الكتلةَ الأخيرةَ وحدَها، فكانت الأولى نصّاً ميتاً يناقضُ
     * الشيفرةَ تحتَه.
     *
     *
