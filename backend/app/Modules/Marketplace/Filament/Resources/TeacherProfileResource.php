            ...
            Section::make('ما يظهرُ في السوق')
                ...
                ->schema([
                    ...
                    */
                    ...
                    /*
                    | ⚠️ مقترحاتٌ لا خيارات، وقائمةٌ مغلقةٌ هنا تمحو البيانات.
                    | `qualifications` حرٌّ بالتصميم على الطرفَين — `['string',
                    | 'max:255']` بلا `Rule::in`، والمعالجُ صندوقُ نصٍّ سطراً لكلِّ
                    | مؤهّل — والمقيسُ على الإنتاج «بكالوريوس تربية» و«بكالريوس
                    | هندسة البرمجيات وعلوم الحاسب»: لا قائمةَ مغلقةً تتّسعُ
                    | لهما. و`Select` بخياراتٍ لا تحوي القيمةَ المخزَّنةَ يعرضُها
                    | فارغةً **ويكتبُها فارغةً عندَ أوّلِ حفظ**: محوٌ صامتٌ لمؤهّلِ
                    | إنسانٍ ثمنُه ضغطةُ زرٍّ واحدة.
                    |
                    | والمقترحاتُ تشتري ما أُريدَ منها فعلاً: «بكالريوس» أعلاه
                    | خطأٌ مطبعيٌّ منشورٌ على السوق، وتصحيحُه صارَ نقرةً لا كتابة.
                    */
                    TagsInput::make('qualifications')
                        ->label('المؤهّلات')
                        ->placeholder('اكتبْ مؤهّلاً أو اختَرْ من المقترحات')
                        ->suggestions([
                            'بكالوريوس',
                            'ليسانس',
                            'دبلوم التربية',
