...
final class PublicFieldAllowlist
{
    ...
    */
    ...
    public const COURSE_TEACHER = [
        ...
        'photo_url',
        /*
        | `is_verified` منشورٌ على بطاقةِ المدرّسِ منذُ ٠٠١، فظهورُه هنا لا
        | يكشفُ شيئاً جديداً — يضعُ الحقيقةَ نفسَها حيثُ يقرأُ المشتري: اسمُ
        | المدرّسِ تحتَ عنوانِ الكورس. وغيابُه كانَ يعني أنّ مدرّساً موثَّقاً
        | يبدو غيرَ موثَّقٍ على كلِّ كارتِ كورسٍ له، وموثَّقاً على بطاقتِه وحدَها.
        */
        'is_verified',
        'trust_score',
        'trust_score_band',
